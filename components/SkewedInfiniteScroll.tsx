const SkewedInfiniteScroll = () => {
	...
	return (
		<div className='flex items-center justify-center py-20'>
			<div
				className='skew-wrapper relative w-full max-w-screen-lg'
				style={{
					WebkitMaskImage: `
          ...
          `,
			...
			>
				<div className='skew-scroll mx-auto grid h-[250px] w-[300px] grid-cols-1 gap-5 sm:w-[600px] sm:grid-cols-2'>
					{[...items, ...items].map((item, index) => (
						<div
							key={item.id + index}
							className='flex cursor-pointer items-center space-x-2 rounded-md border border-gray-100 bg-white px-5 py-4 shadow-md transition-all hover:-translate-y-1 hover:translate-x-1 hover:scale-[1.025] hover:shadow-xl dark:border-gray-800 dark:bg-neutral-900'
						>
							<svg
